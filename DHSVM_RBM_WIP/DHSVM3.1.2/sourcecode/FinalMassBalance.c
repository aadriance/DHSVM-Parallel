...
void FinalMassBalance(FILES *Out, AGGREGATED *Total, WATERBALANCE *Mass,
  ...
  Output = Mass->CumChannelInt +
           (Mass->CumRoadInt - Mass->CumCulvertReturnFlow) + Mass->CumET;

  Input =
      Mass->CumPrecipIn + Mass->CumSnowVaporFlux - Mass->CumCulvertReturnFlow;
  ...
  fprintf(stderr, "\n      RoadInt ....................        %12.3f",
          (Mass->CumRoadInt - Mass->CumCulvertReturnFlow) * 1000);
  fprintf(stderr, "\n  Storage Change .................        %12.3f",
          (NewWaterStorage - Mass->StartWaterStorage) * 1000);
  fprintf(stderr, "\n      Initial Storage ............        %12.3f",
          Mass->StartWaterStorage * 1000);
  fprintf(stderr, "\n      Final Storage ..............        %12.3f",
          NewWaterStorage * 1000);
  fprintf(stderr, "\n          Final SWQ ..............        %12.3f",
          Total->Snow.Swq * 1000);
  fprintf(stderr, "\n          Final Soil Moisture ....        %12.3f",
          (Total->SoilWater + Total->Soil.SatFlow) * 1000);
  fprintf(stderr, "\n          Final Surface ..........        %12.3f",
          (Total->Soil.IExcess + Total->CanopyWater +
           Total->Soil.DetentionStorage) *
              1000);
  ...
  /* Print the runoff final balance results to the output file named
   * final.mass.balance */
  fprintf(Out->FilePtr,
          "\n  ********************************               Depth");
  fprintf(Out->FilePtr,
