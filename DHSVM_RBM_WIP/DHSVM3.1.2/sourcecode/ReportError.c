...
static char *ErrorMessage[] =
    {
        ...
        "the day will not coincide with midnight: ",                   /* 9 */
        ...
        "Cannot use precipitation lapse rate map if there is more than one met "
        "station:",            /* 54 */
        ...
        "Invalid Map->Resolution value for dumping map or image of variable "
        "ID:", /* 66 */
        "The options set in the input file do not support plotting variable "
        "ID:",                                    /* 67 */
        "Buildup coefficients are out of range:", /* 68 */
        "Washoff coefficients are out of range\n Washoff Coeff must be > 0 & "
        "Washoff Expon must be within [-10, 10]:",             /* 69 */
        ...
        "Number of pollutants for each land use category must be equal to the "
        "number of pollutants specified in [POLLUTANTS] section:", /* 74 */
        NULL};
